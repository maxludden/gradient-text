"""GradientConsole is a custom themed class inheriting from rich.console.Console."""
...
class Singleton(type):
    """A metaclass to create a single global GradientConsole instance."""
...
class GradientConsole(Console, metaclass=Singleton):
    ...
    def gradient(self, text: Any, *, style: Optional[StyleType] = None) -> Text:

    @staticmethod
    def max_console() -> Text:
        """Print out `GradientConsole` in a manual gradient"""
        letters = [
    ...
    def gen_explanation(cls) -> Text:
        """Generate an explanation of GradientConsole for demonstration."""
